          ...
          <view class="cover-wrap">
            <view class="cover-header">
              <view class="cover-header-l">
                ...
                <view class="car-desc">小型汽车(非营运)</view>
              </view>
              <view class="cover-header-r">
                <view class="btn-default">{{ item.type }}</view>
              </view>
            </view>
            <view class="cover-footer">
              ...
              >
                ...
                <text class="btn-plain position" v-if="item.isOverdue" @click="handleNavTo">
                  我已办理
                </text>
              </view>
              <view class="cover-footer-r">
